...
REQUIRED_FILES = [
    "README_APPLY_4B436640B.txt",
    "docs/PAPER_SANDBOX_TYPED_RUNTIME_START_OPERATOR_APPROVAL_4B436640B.md",
    "src/tradebot/paper_sandbox_typed_runtime_start_operator_approval.py",
    "tests/test_paper_sandbox_typed_runtime_start_operator_approval_4B436640B.py",
    "tools/apply_4B436640B_paper_sandbox_typed_runtime_start_operator_approval.py",
    "tools/check_4B436640B_paper_sandbox_typed_runtime_start_operator_approval.py",
    "tools/run_4B436640B_paper_sandbox_typed_runtime_start_operator_approval.py",
    "tools/rollback_4B436640B_paper_sandbox_typed_runtime_start_operator_approval.py",
]

...
def run_check(root: Path) -> dict[str, Any]:
    ...
    baseline_preserved = (
        base_30i.get("contract_version") == BASE_30I_CONTRACT_VERSION
        and _nested_bool(base_30i, "module_probe", "ready_internal_harness")
        and _nested_bool(base_30i, "module_probe", "ledger_append_ok")
    )
    safety_flags_ok = (
        _nested_bool(base_30i, "module_probe", "exchange_submit_blocked")
        and _nested_bool(base_30i, "module_probe", "paper_execution_blocked")
        and _nested_bool(base_30i, "module_probe", "paper_candidate_blocked")
        and _nested_bool(base_30i, "module_probe", "live_real_blocked")
        and _nested_bool(base_30i, "module_probe", "order_actions_blocked")
    )
    base_30i_compat_recovered = bool(base_strict_ok.get("30D")) and bool(base_strict_ok.get("30H")) and baseline_preserved and safety_flags_ok
    base_30i_checker_ok = bool(base_strict_ok.get("30I")) or base_30i_compat_recovered
    checks: dict[str, bool] = {
        ...
        "base_30d_checker_ok": base_strict_ok.get("30D", False),
        "base_30h_checker_ok": base_strict_ok.get("30H", False),
        "base_30i_checker_ok": base_30i_checker_ok,
        "base_30i_accepted_baseline_preserved": baseline_preserved,
    ...
    return {
        ...
        "base_checker_strict_ok": base_strict_ok,
        "base_30i_checker_compat_recovered": bool(base_30i_compat_recovered and not base_strict_ok.get("30I", False)),

...
PATCH_ID = "4B436638H-H1"
PATCH_VERSION = "4B.4.3.6.6.38H-H1"
PATCH_NAME = "Observation Metrics Source Report Selection Hotfix"
WRITTEN_FILES = [
    "README_APPLY_4B436638H_H1.txt",
    "docs/PAPER_SANDBOX_OBSERVATION_METRICS_GATE_4B436638H_H1.md",
...
def main() -> int:
    ...
    result = {
        ...
        "source_report_selection_hotfix_applied": not missing_files and not compile_errors,
        "source_report_selection_strict_ready_preferred": True,
        "source_report_selection_gate_artifacts_excluded": True,

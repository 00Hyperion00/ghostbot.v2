...
WRITTEN_FILES = [
    "README_APPLY_4B436639F.txt",
    "docs/PAPER_SANDBOX_OBSERVATION_RUNTIME_METRICS_4B436639F.md",
    "src/tradebot/paper_sandbox_observation_runtime_metrics.py",
    "tests/test_paper_sandbox_observation_runtime_metrics_4B436639F.py",
    "tools/apply_4B436639F_paper_sandbox_observation_runtime_metrics.py",
    "tools/check_4B436639F_paper_sandbox_observation_runtime_metrics.py",
    "tools/run_4B436639F_paper_sandbox_observation_runtime_metrics.py",
    "tools/rollback_4B436639F_paper_sandbox_observation_runtime_metrics.py",
]
...
def main() -> int:
    ...
    result = {
        ...
        "paper_sandbox_observation_runtime_metrics_written": applied,
        "paper_sandbox_observation_runtime_metrics_source_mutation_performed": applied,
        "paper_sandbox_observation_runtime_metrics_runtime_binding_performed": False,

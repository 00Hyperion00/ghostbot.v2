...
PY_FILES = [
    ...
    "tools/apply_4B436631A_H2_source_30z_discovery_recovery.py",
    "tools/check_4B436631A_H2_source_30z_discovery_recovery.py",
    "tools/rollback_4B436631A_H2_source_30z_discovery_recovery.py",
...
def _run_checker(root: Path) -> dict[str, Any]:
    ...
    proc = subprocess.run([sys.executable, str(root / "tools/check_4B436631A_H2_source_30z_discovery_recovery.py"), "--once-json"], cwd=root, text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE, env=env, check=False, timeout=300)
    try:
...
def main() -> int:
    ...
    print("4B.4.3.6.6.31A-H2 source-30Z discovery recovery hotfix applied")

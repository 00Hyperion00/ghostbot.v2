...
def main() -> int:
    ...
    result = {
        ...
        "paper_sandbox_runtime_start_command_contract_written": applied,
        "paper_sandbox_runtime_start_command_contract_source_mutation_performed": applied,
        "paper_sandbox_runtime_start_command_contract_runtime_binding_performed": False,

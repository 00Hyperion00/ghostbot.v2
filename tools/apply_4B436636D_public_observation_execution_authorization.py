...
WRITTEN_FILES = [
    "README_APPLY_4B436636D.txt",
    "docs/PUBLIC_OBSERVATION_EXECUTION_AUTHORIZATION_4B436636D.md",
    "src/tradebot/public_observation_execution_authorization.py",
    "tests/test_public_observation_execution_authorization_4B436636D.py",
    "tools/check_4B436636D_public_observation_execution_authorization.py",
    "tools/run_4B436636D_public_observation_execution_authorization.py",
    "tools/rollback_4B436636D_public_observation_execution_authorization.py",
]

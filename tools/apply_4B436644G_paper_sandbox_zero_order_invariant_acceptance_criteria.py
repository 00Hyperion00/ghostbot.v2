...
REQUIRED_FILES = [
    "README_APPLY_4B436644G.txt",
    "docs/PAPER_SANDBOX_ZERO_ORDER_INVARIANT_ACCEPTANCE_CRITERIA_4B436644G.md",
    "src/tradebot/paper_sandbox_zero_order_invariant_acceptance_criteria.py",
    "tests/test_paper_sandbox_zero_order_invariant_acceptance_criteria_4B436644G.py",
    "tools/apply_4B436644G_paper_sandbox_zero_order_invariant_acceptance_criteria.py",
    "tools/check_4B436644G_paper_sandbox_zero_order_invariant_acceptance_criteria.py",
    "tools/run_4B436644G_paper_sandbox_zero_order_invariant_acceptance_criteria.py",
    "tools/rollback_4B436644G_paper_sandbox_zero_order_invariant_acceptance_criteria.py",
]

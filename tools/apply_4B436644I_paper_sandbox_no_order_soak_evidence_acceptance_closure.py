...
PATCH_ID = "4B436644I"
PATCH_VERSION = "4B.4.3.6.6.44I"
PATCH_NAME = "Paper Sandbox No-Order Soak Evidence Acceptance Closure"
REQUIRED_FILES = [
    "README_APPLY_4B436644I.txt",
    "docs/PAPER_SANDBOX_NO_ORDER_SOAK_EVIDENCE_ACCEPTANCE_CLOSURE_4B436644I.md",
    "src/tradebot/paper_sandbox_no_order_soak_evidence_acceptance_closure.py",
    "tests/test_paper_sandbox_no_order_soak_evidence_acceptance_closure_4B436644I.py",
    "tools/apply_4B436644I_paper_sandbox_no_order_soak_evidence_acceptance_closure.py",
    "tools/check_4B436644I_paper_sandbox_no_order_soak_evidence_acceptance_closure.py",
    "tools/run_4B436644I_paper_sandbox_no_order_soak_evidence_acceptance_closure.py",
    "tools/rollback_4B436644I_paper_sandbox_no_order_soak_evidence_acceptance_closure.py",
]

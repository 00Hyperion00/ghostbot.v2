...
WRITTEN_FILES = [
    "README_APPLY_4B436636C.txt",
    "docs/PUBLIC_OBSERVATION_DRY_RUN_COLLECTOR_4B436636C.md",
    "src/tradebot/public_observation_dry_run_collector.py",
    "tests/test_public_observation_dry_run_collector_4B436636C.py",
    "tools/check_4B436636C_public_observation_dry_run_collector.py",
    "tools/run_4B436636C_public_observation_dry_run_collector.py",
    "tools/rollback_4B436636C_public_observation_dry_run_collector.py",
]

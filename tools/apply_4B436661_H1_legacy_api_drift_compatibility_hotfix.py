...
REQUIRED_FILES = [
    "README_APPLY_4B436661_H1_LEGACY_API_DRIFT_COMPATIBILITY_HOTFIX.txt",
    "docs/LEGACY_API_DRIFT_COMPATIBILITY_HOTFIX_4B436661_H1.md",
    "src/tradebot/release_audit_legacy_api_drift_compatibility.py",
    "tests/test_release_audit_legacy_api_drift_compatibility_4B436661_H1.py",
    "tools/apply_4B436661_H1_legacy_api_drift_compatibility_hotfix.py",
    "tools/check_4B436661_H1_legacy_api_drift_compatibility_hotfix.py",
    "tools/run_4B436661_H1_legacy_api_drift_compatibility_hotfix.py",
    "tools/rollback_4B436661_H1_legacy_api_drift_compatibility_hotfix.py",
]
...
# Restores the public decision export expected by legacy reconciliation tests.
try:
...
def _backup_once(root: Path, relative: str) -> str | None:
    ...
    backup = backup_dir / (relative.replace("/", "__").replace("\\", "__") + ".before_4B436661_H1")
...
def main() -> int:
    ...
    for target in _production_hardening_targets(root):
        mutations.append(_upsert_block(root, target, PRODUCTION_HARDENING_BLOCK, "4B436661-H1 legacy API compatibility start"))
    mutations.append(
        _upsert_block(
            root,
            "src/tradebot/operator_cockpit_v2_read_only.py",
            OPERATOR_COCKPIT_BLOCK,
            "4B436661-H1 legacy API compatibility start",
        )
    )
    ...
    result = {
        ...
        "phase_61_h1_source_mutation_performed": bool(mutated_files),

...
def _run_checker(root: Path) -> dict[str, Any]:
    ...
    proc = subprocess.run(
        [sys.executable, str(root / "tools/check_4B436630W_live_real_final_operator_approval.py"), "--once-json"],
        cwd=root,
        text=True,

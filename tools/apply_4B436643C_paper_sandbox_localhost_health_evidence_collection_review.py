...
PATCH_ID = "4B436643C"
PATCH_VERSION = "4B.4.3.6.6.43C"
PATCH_NAME = "Paper Sandbox Localhost Health Evidence Collection Review"
REQUIRED_FILES = [
    "README_APPLY_4B436643C.txt",
    "docs/PAPER_SANDBOX_LOCALHOST_HEALTH_EVIDENCE_COLLECTION_REVIEW_4B436643C.md",
    "src/tradebot/paper_sandbox_localhost_health_evidence_collection_review.py",
    "tests/test_paper_sandbox_localhost_health_evidence_collection_review_4B436643C.py",
    "tools/apply_4B436643C_paper_sandbox_localhost_health_evidence_collection_review.py",
    "tools/check_4B436643C_paper_sandbox_localhost_health_evidence_collection_review.py",
    "tools/run_4B436643C_paper_sandbox_localhost_health_evidence_collection_review.py",
    "tools/rollback_4B436643C_paper_sandbox_localhost_health_evidence_collection_review.py",
]

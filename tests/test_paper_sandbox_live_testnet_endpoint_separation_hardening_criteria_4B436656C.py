...
from tradebot.paper_sandbox_live_testnet_endpoint_separation_hardening_criteria import evaluate
...
def test_paper_sandbox_live_testnet_endpoint_separation_hardening_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436656C"
    assert payload["patch_version"] == "4B.4.3.6.6.56C"

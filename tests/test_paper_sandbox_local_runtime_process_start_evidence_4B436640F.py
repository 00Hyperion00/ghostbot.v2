...
from tradebot.paper_sandbox_local_runtime_process_start_evidence import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_local_runtime_process_start_evidence_4B436640F_ready_with_seeded_source(tmp_path: Path) -> None:

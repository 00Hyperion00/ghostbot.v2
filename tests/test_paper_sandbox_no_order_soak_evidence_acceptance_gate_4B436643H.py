...
from tradebot.paper_sandbox_no_order_soak_evidence_acceptance_gate import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_soak_evidence_acceptance_gate_4B436643H_ready_with_seeded_source(tmp_path: Path) -> None:

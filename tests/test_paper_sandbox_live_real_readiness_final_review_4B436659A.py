...
from tradebot.paper_sandbox_live_real_readiness_final_review import evaluate
...
def test_paper_sandbox_live_real_readiness_final_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436659A"
    assert payload["patch_version"] == "4B.4.3.6.6.59A"

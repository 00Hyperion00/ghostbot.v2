...
from tradebot.paper_sandbox_typed_no_order_soak_execution_approval import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_typed_no_order_soak_execution_approval_4B436642B_ready_with_seeded_source(tmp_path: Path) -> None:

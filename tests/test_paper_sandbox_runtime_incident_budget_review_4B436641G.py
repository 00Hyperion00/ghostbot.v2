...
from tradebot.paper_sandbox_runtime_incident_budget_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_runtime_incident_budget_review_4B436641G_ready_with_seeded_source(tmp_path: Path) -> None:

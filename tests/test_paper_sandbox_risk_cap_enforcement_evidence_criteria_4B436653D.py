...
from tradebot.paper_sandbox_risk_cap_enforcement_evidence_criteria import evaluate
...
def test_paper_sandbox_risk_cap_enforcement_evidence_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436653D"
    assert payload["patch_version"] == "4B.4.3.6.6.53D"

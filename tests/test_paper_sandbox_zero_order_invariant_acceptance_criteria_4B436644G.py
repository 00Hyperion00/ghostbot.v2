...
from tradebot.paper_sandbox_zero_order_invariant_acceptance_criteria import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_zero_order_invariant_acceptance_criteria_4B436644G_ready_with_seeded_source(tmp_path: Path) -> None:

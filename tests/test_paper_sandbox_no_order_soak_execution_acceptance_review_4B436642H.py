...
from tradebot.paper_sandbox_no_order_soak_execution_acceptance_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_soak_execution_acceptance_review_4B436642H_ready_with_seeded_source(tmp_path: Path) -> None:

...
from tradebot.paper_sandbox_no_order_soak_evidence_acceptance_closure import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_soak_evidence_acceptance_closure_4B436644I_ready_with_seeded_source(tmp_path: Path) -> None:

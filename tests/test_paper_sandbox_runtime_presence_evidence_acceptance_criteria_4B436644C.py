...
from tradebot.paper_sandbox_runtime_presence_evidence_acceptance_criteria import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_runtime_presence_evidence_acceptance_criteria_4B436644C_ready_with_seeded_source(tmp_path: Path) -> None:

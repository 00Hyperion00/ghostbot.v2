...
from tradebot.paper_sandbox_no_order_runtime_metrics_evidence_collection_gate import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_runtime_metrics_evidence_collection_gate_4B436642F_ready_with_seeded_source(tmp_path: Path) -> None:

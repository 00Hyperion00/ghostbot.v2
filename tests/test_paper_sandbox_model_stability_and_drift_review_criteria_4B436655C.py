...
from tradebot.paper_sandbox_model_stability_and_drift_review_criteria import evaluate
...
def test_paper_sandbox_model_stability_and_drift_review_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436655C"
    assert payload["patch_version"] == "4B.4.3.6.6.55C"

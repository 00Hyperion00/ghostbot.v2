...
from tradebot.paper_sandbox_max_live_position_count_criteria import evaluate
...
def test_paper_sandbox_max_live_position_count_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436658D"
    assert payload["patch_version"] == "4B.4.3.6.6.58D"

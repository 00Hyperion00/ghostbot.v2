...
from tradebot.paper_sandbox_daily_loss_circuit_breaker_check import evaluate
...
def test_paper_sandbox_daily_loss_circuit_breaker_check_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651F"
    assert payload["patch_version"] == "4B.4.3.6.6.51F"

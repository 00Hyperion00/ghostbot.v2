...
from tradebot.paper_sandbox_max_symbol_position_trade_limit_review import evaluate
...
def test_paper_sandbox_max_symbol_position_trade_limit_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436649D"
    assert payload["patch_version"] == "4B.4.3.6.6.49D"

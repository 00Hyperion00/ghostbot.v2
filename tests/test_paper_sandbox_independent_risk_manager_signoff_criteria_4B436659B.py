...
from tradebot.paper_sandbox_independent_risk_manager_signoff_criteria import evaluate
...
def test_paper_sandbox_independent_risk_manager_signoff_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436659B"
    assert payload["patch_version"] == "4B.4.3.6.6.59B"

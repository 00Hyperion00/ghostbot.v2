...
from tradebot.paper_sandbox_typed_controlled_paper_trading_soak_approval_ledger import evaluate
...
def test_paper_sandbox_typed_controlled_paper_trading_soak_approval_ledger_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436650B"
    assert payload["patch_version"] == "4B.4.3.6.6.50B"

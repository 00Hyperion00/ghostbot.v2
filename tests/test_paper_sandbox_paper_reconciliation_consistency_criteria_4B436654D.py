...
from tradebot.paper_sandbox_paper_reconciliation_consistency_criteria import evaluate
...
def test_paper_sandbox_paper_reconciliation_consistency_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436654D"
    assert payload["patch_version"] == "4B.4.3.6.6.54D"

...
from tradebot.paper_sandbox_no_order_runtime_metrics_evidence import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_runtime_metrics_evidence_4B436641E_ready_with_seeded_source(tmp_path: Path) -> None:

...
from tradebot.paper_sandbox_reconciliation_dry_run_contract import evaluate
...
def test_paper_sandbox_reconciliation_dry_run_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436648F"
    assert payload["patch_version"] == "4B.4.3.6.6.48F"

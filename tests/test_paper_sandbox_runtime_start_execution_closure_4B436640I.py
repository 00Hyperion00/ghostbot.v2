...
from tradebot.paper_sandbox_runtime_start_execution_closure import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_runtime_start_execution_closure_4B436640I_ready_with_seeded_source(tmp_path: Path) -> None:

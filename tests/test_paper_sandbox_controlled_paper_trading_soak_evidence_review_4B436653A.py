...
from tradebot.paper_sandbox_controlled_paper_trading_soak_evidence_review import evaluate
...
def test_paper_sandbox_controlled_paper_trading_soak_evidence_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436653A"
    assert payload["patch_version"] == "4B.4.3.6.6.53A"

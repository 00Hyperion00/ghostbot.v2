...
from tradebot.paper_sandbox_operator_typed_live_approval_contract import evaluate
...
def test_paper_sandbox_operator_typed_live_approval_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436659C"
    assert payload["patch_version"] == "4B.4.3.6.6.59C"

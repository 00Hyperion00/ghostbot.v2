...
from tradebot.paper_sandbox_p0_production_hardening_closure import evaluate
...
def test_paper_sandbox_p0_production_hardening_closure_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436656I"
    assert payload["patch_version"] == "4B.4.3.6.6.56I"

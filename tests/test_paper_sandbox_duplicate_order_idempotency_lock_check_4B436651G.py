...
from tradebot.paper_sandbox_duplicate_order_idempotency_lock_check import evaluate
...
def test_paper_sandbox_duplicate_order_idempotency_lock_check_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651G"
    assert payload["patch_version"] == "4B.4.3.6.6.51G"

...
from tradebot.paper_sandbox_paper_submit_typed_operator_approval_contract import evaluate
...
def test_paper_sandbox_paper_submit_typed_operator_approval_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651B"
    assert payload["patch_version"] == "4B.4.3.6.6.51B"

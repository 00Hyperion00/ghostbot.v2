...
from tradebot.paper_sandbox_external_evidence_manifest_contract import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_external_evidence_manifest_contract_4B436644B_ready_with_seeded_source(tmp_path: Path) -> None:

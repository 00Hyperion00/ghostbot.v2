...
from tradebot.paper_sandbox_paper_endpoint_hard_separation_check import evaluate
...
def test_paper_sandbox_paper_endpoint_hard_separation_check_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651C"
    assert payload["patch_version"] == "4B.4.3.6.6.51C"

...
from tradebot.paper_sandbox_order_schema_validation_contract import evaluate
...
def test_paper_sandbox_order_schema_validation_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436648C"
    assert payload["patch_version"] == "4B.4.3.6.6.48C"

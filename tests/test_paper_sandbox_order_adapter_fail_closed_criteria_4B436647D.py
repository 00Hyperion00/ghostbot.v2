...
from tradebot.paper_sandbox_order_adapter_fail_closed_criteria import evaluate
...
def test_paper_sandbox_order_adapter_fail_closed_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436647D"
    assert payload["patch_version"] == "4B.4.3.6.6.47D"

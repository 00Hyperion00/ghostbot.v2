...
from tradebot.paper_sandbox_no_order_runtime_health_probe_evidence import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_runtime_health_probe_evidence_4B436641D_ready_with_seeded_source(tmp_path: Path) -> None:

...
from tradebot.paper_sandbox_soak_window_evidence_snapshot_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_soak_window_evidence_snapshot_review_4B436643E_ready_with_seeded_source(tmp_path: Path) -> None:

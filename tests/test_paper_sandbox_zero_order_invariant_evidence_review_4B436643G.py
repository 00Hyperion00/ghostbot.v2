...
from tradebot.paper_sandbox_zero_order_invariant_evidence_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_zero_order_invariant_evidence_review_4B436643G_ready_with_seeded_source(tmp_path: Path) -> None:

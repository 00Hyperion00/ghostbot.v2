...
from tradebot.paper_sandbox_withdrawal_permission_denial_criteria import evaluate
...
def test_paper_sandbox_withdrawal_permission_denial_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436657C"
    assert payload["patch_version"] == "4B.4.3.6.6.57C"

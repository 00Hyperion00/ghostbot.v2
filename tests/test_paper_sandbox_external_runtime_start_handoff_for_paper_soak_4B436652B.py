...
from tradebot.paper_sandbox_external_runtime_start_handoff_for_paper_soak import evaluate
...
def test_paper_sandbox_external_runtime_start_handoff_for_paper_soak_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436652B"
    assert payload["patch_version"] == "4B.4.3.6.6.52B"

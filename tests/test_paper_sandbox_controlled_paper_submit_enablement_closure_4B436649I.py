...
from tradebot.paper_sandbox_controlled_paper_submit_enablement_closure import evaluate
...
def test_paper_sandbox_controlled_paper_submit_enablement_closure_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436649I"
    assert payload["patch_version"] == "4B.4.3.6.6.49I"

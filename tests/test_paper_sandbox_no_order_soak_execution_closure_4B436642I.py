...
from tradebot.paper_sandbox_no_order_soak_execution_closure import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_soak_execution_closure_4B436642I_ready_with_seeded_source(tmp_path: Path) -> None:

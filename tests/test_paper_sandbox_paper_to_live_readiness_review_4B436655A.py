...
from tradebot.paper_sandbox_paper_to_live_readiness_review import evaluate
...
def test_paper_sandbox_paper_to_live_readiness_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436655A"
    assert payload["patch_version"] == "4B.4.3.6.6.55A"

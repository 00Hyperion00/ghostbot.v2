...
from tradebot.paper_sandbox_localhost_health_evidence_collection_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_localhost_health_evidence_collection_review_4B436643C_ready_with_seeded_source(tmp_path: Path) -> None:

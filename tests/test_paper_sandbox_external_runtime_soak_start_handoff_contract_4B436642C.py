...
from tradebot.paper_sandbox_external_runtime_soak_start_handoff_contract import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_external_runtime_soak_start_handoff_contract_4B436642C_ready_with_seeded_source(tmp_path: Path) -> None:

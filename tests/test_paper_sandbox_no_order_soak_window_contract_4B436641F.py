...
from tradebot.paper_sandbox_no_order_soak_window_contract import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_soak_window_contract_4B436641F_ready_with_seeded_source(tmp_path: Path) -> None:

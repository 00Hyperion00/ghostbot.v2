...
from tradebot.paper_sandbox_live_credential_isolation_audit_review import evaluate
...
def test_paper_sandbox_live_credential_isolation_audit_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436657A"
    assert payload["patch_version"] == "4B.4.3.6.6.57A"

...
from tradebot.paper_sandbox_reconciliation_and_audit_arming_criteria import evaluate
...
def test_paper_sandbox_reconciliation_and_audit_arming_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436652G"
    assert payload["patch_version"] == "4B.4.3.6.6.52G"

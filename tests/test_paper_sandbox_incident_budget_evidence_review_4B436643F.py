...
from tradebot.paper_sandbox_incident_budget_evidence_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_incident_budget_evidence_review_4B436643F_ready_with_seeded_source(tmp_path: Path) -> None:

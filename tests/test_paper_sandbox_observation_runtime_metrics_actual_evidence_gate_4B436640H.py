...
from tradebot.paper_sandbox_observation_runtime_metrics_actual_evidence_gate import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_observation_runtime_metrics_actual_evidence_gate_4B436640H_ready_with_seeded_source(tmp_path: Path) -> None:

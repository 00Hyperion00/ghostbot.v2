...
from tradebot.paper_sandbox_external_runtime_presence_evidence_collection_handoff import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_external_runtime_presence_evidence_collection_handoff_4B436643B_ready_with_seeded_source(tmp_path: Path) -> None:

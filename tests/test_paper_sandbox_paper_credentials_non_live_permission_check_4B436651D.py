...
from tradebot.paper_sandbox_paper_credentials_non_live_permission_check import evaluate
...
def test_paper_sandbox_paper_credentials_non_live_permission_check_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651D"
    assert payload["patch_version"] == "4B.4.3.6.6.51D"

...
from tradebot.paper_sandbox_reconciliation_mandatory_preflight_criteria import evaluate
...
def test_paper_sandbox_reconciliation_mandatory_preflight_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436650G"
    assert payload["patch_version"] == "4B.4.3.6.6.50G"

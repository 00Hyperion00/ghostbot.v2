...
from tradebot.paper_sandbox_runtime_start_execution_authorization_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_runtime_start_execution_authorization_review_4B436640A_ready_with_seeded_source(tmp_path: Path) -> None:

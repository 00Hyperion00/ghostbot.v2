...
from tradebot.paper_sandbox_health_stability_acceptance_review import evaluate
...
def test_paper_sandbox_health_stability_acceptance_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436646D"
    assert payload["patch_version"] == "4B.4.3.6.6.46D"

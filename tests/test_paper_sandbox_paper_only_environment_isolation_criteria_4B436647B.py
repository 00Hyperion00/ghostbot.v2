...
from tradebot.paper_sandbox_paper_only_environment_isolation_criteria import evaluate
...
def test_paper_sandbox_paper_only_environment_isolation_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436647B"
    assert payload["patch_version"] == "4B.4.3.6.6.47B"

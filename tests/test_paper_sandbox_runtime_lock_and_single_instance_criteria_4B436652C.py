...
from tradebot.paper_sandbox_runtime_lock_and_single_instance_criteria import evaluate
...
def test_paper_sandbox_runtime_lock_and_single_instance_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436652C"
    assert payload["patch_version"] == "4B.4.3.6.6.52C"

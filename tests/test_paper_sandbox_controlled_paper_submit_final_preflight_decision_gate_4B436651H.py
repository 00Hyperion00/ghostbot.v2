...
from tradebot.paper_sandbox_controlled_paper_submit_final_preflight_decision_gate import evaluate
...
def test_paper_sandbox_controlled_paper_submit_final_preflight_decision_gate_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651H"
    assert payload["patch_version"] == "4B.4.3.6.6.51H"

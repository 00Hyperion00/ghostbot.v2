...
from tradebot.paper_sandbox_paper_submit_audit_reconciliation_review import evaluate
...
def test_paper_sandbox_paper_submit_audit_reconciliation_review_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436649F"
    assert payload["patch_version"] == "4B.4.3.6.6.49F"

...
from tradebot.paper_sandbox_paper_pnl_and_drawdown_acceptance_criteria import evaluate
...
def test_paper_sandbox_paper_pnl_and_drawdown_acceptance_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436654B"
    assert payload["patch_version"] == "4B.4.3.6.6.54B"

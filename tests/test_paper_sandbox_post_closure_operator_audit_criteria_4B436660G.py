...
from tradebot.paper_sandbox_post_closure_operator_audit_criteria import evaluate
...
def test_paper_sandbox_post_closure_operator_audit_criteria_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436660G"
    assert payload["patch_version"] == "4B.4.3.6.6.60G"

...
from tradebot.paper_sandbox_signal_to_intended_order_mapping_contract import evaluate
...
def test_paper_sandbox_signal_to_intended_order_mapping_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436648B"
    assert payload["patch_version"] == "4B.4.3.6.6.48B"

...
from tradebot.paper_sandbox_localhost_health_probe_evidence_gate import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_localhost_health_probe_evidence_gate_4B436642E_ready_with_seeded_source(tmp_path: Path) -> None:

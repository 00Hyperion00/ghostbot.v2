...
from tradebot.paper_sandbox_max_notional_quantity_trade_count_caps_check import evaluate
...
def test_paper_sandbox_max_notional_quantity_trade_count_caps_check_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436651E"
    assert payload["patch_version"] == "4B.4.3.6.6.51E"

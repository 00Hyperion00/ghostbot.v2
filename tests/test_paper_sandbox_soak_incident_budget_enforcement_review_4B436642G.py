...
from tradebot.paper_sandbox_soak_incident_budget_enforcement_review import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_soak_incident_budget_enforcement_review_4B436642G_ready_with_seeded_source(tmp_path: Path) -> None:

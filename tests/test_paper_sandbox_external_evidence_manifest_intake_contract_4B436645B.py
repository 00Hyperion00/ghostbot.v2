...
from tradebot.paper_sandbox_external_evidence_manifest_intake_contract import evaluate
...
def test_paper_sandbox_external_evidence_manifest_intake_contract_ready_and_locked(tmp_path: Path) -> None:
    ...
    assert payload["patch_id"] == "4B436645B"
    assert payload["patch_version"] == "4B.4.3.6.6.45B"

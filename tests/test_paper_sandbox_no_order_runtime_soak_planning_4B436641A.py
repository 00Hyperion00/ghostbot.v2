...
from tradebot.paper_sandbox_no_order_runtime_soak_planning import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_no_order_runtime_soak_planning_4B436641A_ready_with_seeded_source(tmp_path: Path) -> None:

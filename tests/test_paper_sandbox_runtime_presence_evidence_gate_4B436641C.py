...
from tradebot.paper_sandbox_runtime_presence_evidence_gate import PATCH_ID, PATCH_VERSION, evaluate
...
def test_paper_sandbox_runtime_presence_evidence_gate_4B436641C_ready_with_seeded_source(tmp_path: Path) -> None:

...
Apply:
  python tools/apply_4B436644D_paper_sandbox_health_evidence_acceptance_criteria.py

Check:
  set PYTHONPATH=src
  python tools/check_4B436644D_paper_sandbox_health_evidence_acceptance_criteria.py --once-json

Run:
  set PYTHONPATH=src
  python tools/run_4B436644D_paper_sandbox_health_evidence_acceptance_criteria.py --reports-dir .\reports\recovery --once-json

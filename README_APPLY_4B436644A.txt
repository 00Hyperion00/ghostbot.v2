...
Apply:
  python tools/apply_4B436644A_paper_sandbox_no_order_soak_evidence_acceptance_review.py

Check:
  set PYTHONPATH=src
  python tools/check_4B436644A_paper_sandbox_no_order_soak_evidence_acceptance_review.py --once-json

Run:
  set PYTHONPATH=src
  python tools/run_4B436644A_paper_sandbox_no_order_soak_evidence_acceptance_review.py --reports-dir .\reports\recovery --once-json

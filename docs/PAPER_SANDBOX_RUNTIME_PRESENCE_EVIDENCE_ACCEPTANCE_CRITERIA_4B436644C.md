...
- Source phase: `4B.4.3.6.6.44B` / `External Evidence Manifest Contract`
- Current patch: `4B.4.3.6.6.44C` / `Paper Sandbox Runtime Presence Evidence Acceptance Criteria`
- Next phase: `4B.4.3.6.6.44D` / `Paper Sandbox Health Evidence Acceptance Criteria`
...
```text
PAPER_SANDBOX_RUNTIME_PRESENCE_EVIDENCE_ACCEPTANCE_CRITERIA_READY_CRITERIA_ONLY_RUNTIME_NOT_STARTED_BY_PATCH_EVIDENCE_NOT_ACCEPTED_BY_PATCH_NO_PAPER_ORDER_NO_NETWORK_ORDER_NO_LIVE_NO_EXCHANGE_SUBMIT_LOCKED
```

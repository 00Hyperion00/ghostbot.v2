...
## Decision
- `decision`: `PAPER_SANDBOX_CANDIDATE_UNLOCK_GATE_EXPLICIT_UNLOCK_REQUIRED_NO_EXCHANGE_SUBMIT_NO_LIVE_REAL`
- `read_only`: `True`
- `approved_for_paper_sandbox_candidate_unlock_gate`: `False`
- `approved_for_explicit_paper_candidate_unlock`: `False`
- `approved_for_sandbox_only_order_enablement_preflight`: `True`
- `approved_for_paper_sandbox_candidate`: `False`
...
- `explicit_candidate_unlock_verified`: `False`
...
- `PAPER_CANDIDATE_UNLOCK_OPERATOR_ID_REQUIRED`
- `PAPER_CANDIDATE_UNLOCK_NOT_ISSUED`
- `PAPER_CANDIDATE_UNLOCK_TOKEN_MISMATCH`

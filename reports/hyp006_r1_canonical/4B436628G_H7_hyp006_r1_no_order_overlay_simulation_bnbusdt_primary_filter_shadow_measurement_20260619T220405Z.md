...
|---|---:|---:|---:|---:|---:|---:|---|
| BNBUSDT | 13 | 76.923077 | 126.61364 | 5.432608 | -312.205541 | -426.691375 | MEASUREMENT_GUARD_PASS |
...
| category | key | matured | mean bps | PF | reason |
|---|---|---:|---:|---:|---|
| gate_combo | MIN_WICK_PCT_REFERENCE | 5 | 196.653831 | 19.801511 | LOW_SAMPLE_WATCHLIST_NOT_USED_IN_H7_BNBUSDT_MEASUREMENT |
| risk_bucket | LOW_WICK | 5 | 196.653831 | 19.801511 | LOW_SAMPLE_WATCHLIST_NOT_USED_IN_H7_BNBUSDT_MEASUREMENT |
| gate_combo | MIN_WICK_PCT_REFERENCE + MAX_COMPRESSION_RATIO_REFERENCE | 8 | 253.073254 | 16.432644 | LOW_SAMPLE_WATCHLIST_NOT_USED_IN_H7_BNBUSDT_MEASUREMENT |
| risk_bucket | HIGH_COMPRESSION_LOW_WICK | 8 | 253.073254 | 16.432644 | LOW_SAMPLE_WATCHLIST_NOT_USED_IN_H7_BNBUSDT_MEASUREMENT |
| risk_bucket | HIGH_SLIPPAGE | 5 | 73.684296 | 8.712051 | LOW_SAMPLE_WATCHLIST_NOT_USED_IN_H7_BNBUSDT_MEASUREMENT |

### Do-not-relax blocklist
| category | key | matured | mean bps | PF | reason |
|---|---|---:|---:|---:|---|
| gate_combo | RECLAIM_REFERENCE_CLOSE + MIN_WICK_PCT_REFERENCE | 37 | -13.143897 | 0.86865 | EXPLICIT_DO_NOT_RELAX_BLOCKLIST_ENFORCED |

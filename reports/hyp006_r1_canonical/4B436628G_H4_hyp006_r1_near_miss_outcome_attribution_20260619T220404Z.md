...
- near_miss_mean_return_bps: `83.238151`
...
- `MIN_WICK_PCT_REFERENCE + MAX_COMPRESSION_RATIO_REFERENCE`: count `8`, matured `8`, mean `253.073254`, win_rate `75.0`, pf `16.432644`, research_candidate `True`
...
- `MIN_WICK_PCT_REFERENCE`: count `5`, matured `5`, mean `196.653831`, win_rate `80.0`, pf `19.801511`, research_candidate `True`

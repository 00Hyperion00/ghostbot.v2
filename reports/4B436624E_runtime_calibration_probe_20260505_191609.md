...
- raw_distribution: `{'HOLD': 0, 'BUY': 16, 'SELL': 25}`
...
| action_seek_medium | 51.219512 | 48.780488 | `{'HOLD': 20, 'BUY': 6, 'SELL': 15}` | `{'RAW_ACTION_FIRST_ACCEPT': 21, 'REJECT_LOW_MARGIN': 20}` |
| no_margin_probe | 100.0 | 0.0 | `{'HOLD': 0, 'BUY': 16, 'SELL': 25}` | `{'RAW_ACTION_FIRST_ACCEPT': 41}` |

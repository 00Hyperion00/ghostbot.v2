...
# Safety: registration is blocked unless the baseline task is explicitly Disabled.
...
Register-ScheduledTask -TaskName $TaskName -Action $Action -Trigger $Trigger -Settings $Settings -Description "HYP-005-R1 eight-symbol fresh-ledger no-order shadow collection cycle. No paper/live/order actions." -Force

Write-Host "Registered task: $TaskName"
Write-Host "Baseline task confirmed Disabled: $BaselineTaskName"
Write-Host "Cycle script: $CycleScript"
Write-Host "Safety: HYP005_R1 fresh ledger only; no paper/live/order actions are enabled."

...
- generated_at_utc: `2026-06-01T21:05:57Z`
- raw_observation_count: `3194`
- unique_observation_count: `28`
- duplicate_removed_count: `3166`
- shadow_observation_count: `28`
- shadow_sample_target: `30`
- progress_pct: `93.333333`
- matured_forward_return_count: `25`
- maturity_pending_count: `3`
- true_missing_required_fields_pct: `1.071429`
...
- BTCUSDT: count=2, matured=1, pending=1, mean_edge=158.648312, pf=999.0, max_slip=3.828547, flags=SYMBOL_MATURITY_PENDING_PRESENT
...
HYP-005 shadow quality audit is blocked with 28 unique shadow observations after canonical deduplication. Keep paper/live/order disabled. Resolve blockers before any transition gate: TRUE_REQUIRED_FIELDS_MISSING_HIGH. Review warnings: MATURED_MEAN_FORWARD_EDGE_NEGATIVE, MATURED_PROFIT_FACTOR_LOW, OBSERVATION_DUPLICATES_REMOVED_FROM_QUALITY_METRICS, SHADOW_SAMPLE_COUNT_BELOW_ACCEPTANCE_TARGET, SHADOW_SLIPPAGE_PROXY_HIGH.
